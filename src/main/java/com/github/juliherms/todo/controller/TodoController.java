package com.github.juliherms.todo.controller;

import com.github.juliherms.todo.entities.Todo;
import com.github.juliherms.todo.service.TodoService;
...
public class TodoController {
    ...
    Mono<ResponseEntity<Todo>> findTodoById(@PathVariable long id) {
...
//                .defaultIfEmpty(ResponseEntity.notFound().build());
    ...
    Mono<Void> deleteTodoById(@PathVariable long id) {
